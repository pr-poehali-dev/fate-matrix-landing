          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="reveal order-2 md:order-1">
              ...
              <p className="text-[#555] font-light leading-relaxed mb-6">
                Практикующий нумеролог и консультант по матрице судьбы с 8-летним опытом. 
                Провела более 2 000 индивидуальных консультаций для людей из разных стран.
              </p>
              <p className="text-[#555] font-light leading-relaxed mb-10">
                Специализируется на работе с жизненными кризисами, поиском предназначения 
                и выстраиванием гармоничных отношений через понимание числовых энергий.
              </p>
              <div className="grid grid-cols-3 gap-6">
                {[
                  { num: "8+", label: "лет практики" },
                  { num: "2000+", label: "консультаций" },
                  { num: "97%", label: "довольных клиентов" },
                ].map((stat, i) => (
                  <div key={i}>
